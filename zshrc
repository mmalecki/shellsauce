...
alias dateber='TZ="Europe/Berlin" date'
...
export PATH="$HOME/.tfenv/bin:$GOPATH/bin:$HOME/bin:$HOME/npm/bin:$HOME/.tgenv/bin:$HOME/.pkenv/bin:$HOME/.cargo/bin:$HOME/.istioctl/bin:$PATH"
